...
<p align="center">
  <img src="https://skillicons.dev/icons?i=js,html,css,nodejs,express&theme=dark" alt="Languages & Frameworks Skill Icons"/>
  <br/>
  <img src="https://skillicons.dev/icons?i=supabase,firebase,mongodb,git,postman,paypal&theme=dark" alt="Tools & Platforms Skill Icons"/>
</p>
...
### 🔹 [Online Marketplace](https://github.com/J3ZZ3/Marketplace)  
![React](https://img.shields.io/badge/React.js-20232A?style=flat&logo=react&logoColor=61DAFB)  
A platform for users to buy and sell items securely.

**🔧 Tech:** React.js (completed), Node.js, Firebase, Redux  
🔗 [Frontend](https://github.com/J3ZZ3/Marketplace) | [Backend](https://github.com/J3ZZ3/Marketplace_Server)

---

### 🔹 [Employee Management System](https://github.com/J3ZZ3/employeeApp-frontend)  
A robust CRUD system for managing employees with admin roles.

**🔧 Tech:** React.js (completed), Node.js, Express.js, Firebase  
🔗 [Frontend](https://github.com/J3ZZ3/employeeApp-frontend) | [Backend](https://github.com/J3ZZ3/employeeApp-backend)

---

### 🔹 [Audio Recorder App](https://github.com/J3ZZ3/AudioRecorderApp)  
Voice note app with offline support and CRUD functionality.

**🔧 Tech:** React Native (completed)  
🔗 [GitHub Repo](https://github.com/J3ZZ3/AudioRecorderApp)
...
- How to build and scale CRUD APIs  
- Transitioning into tech as a junior dev  
...
📧 [jesse.mashoana@gmail.com](mailto:jesse.mashoana@gmail.com)
...
⭐️ _Don’t forget to star my repos if you find them useful!_
